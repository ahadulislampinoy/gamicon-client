          ...
          <div className="md:h-80 flex flex-col sm:flex-row bg-gray-100 text-gray-800 rounded-lg overflow-hidden ">
            <div className="w-full sm:w-1/2 lg:w-2/5 flex flex-col p-4 sm:p-5 sm:pt-8 justify-between">
              <div className="flex justify-between items-center sm:block">
                ...
                <h4 className="text-lg md:text-xl lg:text-2xl font-semibold mb-4">
                  ${product.resellPrice}
                </h4>
              </div>
              ...
              <div>
                <Link
                  ...
                  className="inline-block bg-gradient-to-r from-emerald-500 to-green-600 shadow text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-6 py-2"
                >
                  More
                </Link>
              </div>
