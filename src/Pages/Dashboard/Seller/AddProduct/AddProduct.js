...
const AddProduct = () => {
  ...
  return (
    <div>
      <div class="pb-6 sm:pb-8 lg:pb-12 pt-3">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          >
            <div>
              ...
              <select
                class="w-full bg-gray-100 text-gray-800 rounded outline-none transition duration-100 p-3"
                {...register("category")}
              >
            ...
            <div>
              <label class="inline-block text-gray-800 text-sm sm:text-base mb-1">
                Profile Photo
              </label>
              <label class="flex items-center bg-gray-100 text-gray-800 rounded p-3 cursor-pointer">
                <h2 class="text-gray-800 overflow-hidden">
                  {imgUrl ? (
                    imgUrl
                  ) : (
                    <>
            ...
            <div class="sm:col-span-2">
              ...
              <textarea
                ...
                class="w-full h-40 bg-gray-100 text-gray-800 rounded outline-none transition duration-100 p-3"
              ></textarea>{" "}
              {errors?.description && (
            ...
            <div class="sm:col-span-2 flex justify-between items-center">
              <button class="inline-block bg-gradient-to-r from-emerald-700 to-green-600  text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
